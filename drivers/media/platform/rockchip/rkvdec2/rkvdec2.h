...
enum rkvdec2_image_fmt {
	RKVDEC2_IMG_FMT_ANY = 0,
	RKVDEC2_IMG_FMT_420_8BIT,
	RKVDEC2_IMG_FMT_420_10BIT,
	RKVDEC2_IMG_FMT_422_8BIT,
	RKVDEC2_IMG_FMT_422_10BIT,
};
...
struct rkvdec2_coded_fmt_ops {
	...
	enum rkvdec2_image_fmt (*get_image_fmt)(struct rkvdec2_ctx *ctx,
					       struct v4l2_ctrl *ctrl);
};

struct rkvdec2_decoded_fmt_desc {
	u32 fourcc;
...
struct rkvdec2_coded_fmt_desc {
	...
	const struct rkvdec2_decoded_fmt_desc *decoded_fmts;
	u32 subsystem_flags;
};
